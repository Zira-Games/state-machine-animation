...
class BehaviorSubjectBuilder<T> extends StreamBuilder<T> {
  ...
  BehaviorSubjectBuilder(
      {required this.subject, required this.subjectBuilder, super.key})
      : super(
            stream: subject,
            initialData: subject.value,
            builder: (context, animationProperty) =>
                subjectBuilder(context, animationProperty.data!));
}
