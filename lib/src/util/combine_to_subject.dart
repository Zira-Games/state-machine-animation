...
BehaviorSubject<T> combineSubject2<A, B, T>(BehaviorSubject<A> subjectA, BehaviorSubject<B> subjectB, T Function(A a, B b) combiner){
  final transformationSubject = BehaviorSubject<T>.seeded(combiner(subjectA.value, subjectB.value));
  transformationSubject.addStream(Rx.combineLatest2<A, B, T>(subjectA.startWith(subjectA.value), subjectB.startWith(subjectB.value), combiner));
...
BehaviorSubject<T> combineSubject3<A, B, C, T>(
  ...
  final transformationSubject = BehaviorSubject<T>.seeded(combiner(streamA.value, streamB.value, streamC.value));
